...
SECRET_KEY = 'django-insecure-u1%83h5*awa2%@(izan-4l&d9-*of+bhlzo2ou&(l3z3h8z)qw'
...
LOGIN_REDIRECT_URL = '/book/book-list'
LOGOUT_REDIRECT_URL = '/book/book-list'

cloudinary.config( 
    cloud_name = "deyp4pmfb", 
    api_key = os.getenv('cloudinary_api'), 
    api_secret = os.getenv('cloudinary_secrets'),
    secure=True
)
